...
public class Logica {
    ...
    //Simbolos: (!) negacion, (^) conjuncion, (v) disyuncion, (->) condicional, (<->) bicondicional
    ...
    Logica(){
        separarCadena(expresion);
        convertirAPosfijo(expresionSeparada);
        evaluar();
        imprimirResultados();
    }
    ...
    private void convertirAPosfijo(ArrayList<String> arreglo){
    ...
    private boolean tablaNegacion(boolean a){
        return (a == true) ? false : true;
    }
    
    private boolean tablaDisyuncion(boolean a, boolean b){
        return (a == false && b == false) ? false : true;
    }
    
    private boolean tablaBicondicional(boolean a, boolean b){
